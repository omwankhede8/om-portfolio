      ...
      >
        ...
        >
          <p className="mb-7 max-w-4xl text-[16px] font-Ovo">
            ...
            dynamic web applications using MongoDB, Express.js, React.js,React
            Native Next.js and Node.js. I recently completed an internship,
            where I honed my skills in creating responsive and user-friendly
            interfaces, developing RESTful APIs, and implementing database
            management solutions. Eager to apply my knowledge to real-world
            projects, I am driven by a strong desire to learn and adapt to new
            technologies. I am committed to delivering high-quality solutions
            and continuously improving my technical expertise. Open to
